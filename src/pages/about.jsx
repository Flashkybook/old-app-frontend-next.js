                    ...
                    <p className='mt-2 text-lg flex items-center justify-start'>
                        ...
                        <div className="inline-block">
                            <div className='whitespace-nowrap pt-1 mx-auto flex space-x-1'>
                                ...
                                {/* <a href='https://github.com/RagAndRoll' className='icon-social' target={"_blank"} rel="noreferrer">
                                ...
                                <a href='https://angel-riera.vercel.app/' className='icon-social' target={"_blank"} rel="noreferrer" >
